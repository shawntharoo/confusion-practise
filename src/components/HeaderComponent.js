                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p> We take inspiron from the World's best cuisines, and create a unique fusion experience. pur limpsmacking creations will tickle your culinery senses.</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            <FormGroup>
                                ...
                                <Input type="text" id="ussername" name="username" innerRef={((input) => this.username = input)} />
                            </FormGroup>
                            <FormGroup>
