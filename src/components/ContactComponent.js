...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        this.props.postFeedback(values.firstname, values.lastname, values.telnum, values.email, values.agree, values.conatctType, values.message);
                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    messages = {{
                                        ...
                                        maxLength: 'Must be 15 numbers or length',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    messages = {{
                                        required : 'Required',
                                        validEmail: 'Email shoud be a valid Email'
                                    }}
                                    />
                                </Col>
                            </Row>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={{ size: 3, offset: 1 }}>
                                    <Control.select model=".conatctType" name="conatactType" className="form-control">
                                        <option>Tel .</option>
                                        <option> Email </option>
                                    </Control.select>
                                </Col>
